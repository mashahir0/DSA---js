...
console.log(binarys([1,2,3,4,5],3))
...
function recbinary(arr,target,left =0 , right = arr.length -1){
    ...
    if(target < arr[mid]){
        return recbinary(arr,target,left = mid -1,right)
    }else{
        return recbinary(arr,target,left,right = mid +1)
    }
}


console.log(recbinary([1,2,3,4,5],3));
